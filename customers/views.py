    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            if vendors:
                ...
                messages.success(request, f"{allot.Vendor_Name} is your delivery executive. Contact: {allot.Vendor_Phone}.")
            else:
                messages.success(request, "Your details are saved. We’ll confirm your delivery partner shortly.")
